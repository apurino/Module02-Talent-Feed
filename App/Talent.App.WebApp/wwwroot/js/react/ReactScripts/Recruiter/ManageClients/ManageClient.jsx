...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://profilestandard.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'https://identitystandard.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
