...
export default class TalentMatching extends React.Component {
    ...
    //loadJobs(data) { // url: 'https://talentstandard.azurewebsites.net/listing/listing/getEmployerJobs',
        
    //loadSelectedJob(data) url: 'https://talentstandard.azurewebsites.net/listing/listing/getJobForTalentMatching',

    //loadTalentList()  url: 'https://profilestandard.azurewebsites.net/profile/profile/getTalentList',

    //loadTalentFilterList() //url: 'https://profilestandard.azurewebsites.net/profile/profile/getTalentListFilter',

    //loadEmployerFilterList() //url: 'https://profilestandard.azurewebsites.net/profile/profile/getEmployerListFilter',


    // loadEmployerList() // url: 'https://profilestandard.azurewebsites.net/profile/profile/getEmployerList',
    //loadSuggestionList   url: 'https://profilestandard.azurewebsites.net/profile/profile/getSuggestionList',

   // saveCompanyTalents()   url: 'https://profilestandard.azurewebsites.net/profile/profile/addTalentSuggestions',
     

    //saveJobTalents()    url: 'https://profilestandard.azurewebsites.net/profile/profile/addTalentSuggestions',
